      ...
      <div class="navbar navbar-fixed-top scroll-hide">
        ...
        <div class="container-fluid main-nav clearfix">
          <div class="nav-collapse">
            <ul class="nav">
              <li>
                <a href="HomeAction"><span aria-hidden="true" class="se7en-home"></span>主页</a>
              </li>
                  ...
                  <div class="panel">
                    <div class="panel-heading">
                      <div class="panel-title">
                        <a class="accordion-toggle" data-parent="#accordion" data-toggle="collapse" href="#collapseOne"><div class="caret pull-right"></div>维度选择</a>
                      </div>
                    </div>
                    <div class="panel-collapse collapse in" id="collapseOne">
                      ...
                      <div class="form-group">
        				      ...
        				      <label class="checkbox-inline" ><input id="checkplace"  class="checkclass" name="checkAll" type="checkbox"><span></span>地点</label>
        				      <label class="checkbox-inline" ><input id="checkperson" class="checkclass" name="checkAll" type="checkbox"><span></span>人物</label>
        			        </div>
                      </div>
                    </div>
                  </div>
