            ...
            <div class="container-fluid main-nav clearfix">
                <div class="nav-collapse">
                    <ul class="nav">
                        ...
                        <li>
                            <a class="current" href="charts.html">
                    ...
                    <div class="widget-content">
                        <div class="panel-group" id="accordion">
                                ...
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <a class="accordion-toggle" data-parent="#accordion" data-toggle="collapse" href="#collapseOne">
                                            <div class="caret pull-right"></div>维度选择</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label class="checkbox-inline">
                                                <input id="checktime" class="checkclass" name="checkAll" type="checkbox"><span></span>时间</label>
                                            <label class="checkbox-inline">
                                                <input id="checkplace" class="checkclass" name="checkAll" type="checkbox"><span></span>地点</label>
                                            <label class="checkbox-inline">
                                                <input id="checkperson" class="checkclass" name="checkAll" type="checkbox"><span></span>人物</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="panel filter-categories">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <a class="accordion-toggle" data-parent="#accordion" data-toggle="collapse" href="#collapseO">
                                ...
                                <div class="panel">
                                    <div class="panel-body">
                                        ...
                                        <div id="place_key" class="form-group" style="display: none">
                                            <label><b>地点关键词</b></label>
                                            <input id="place" type="text" class="form-control" value="">
                                        </div>
                                        <!-- search for the person -->
                                        <div id="person_key" class="form-group" style="display: none">
                                            <label><b>人物关键词</b></label>
                                            <input id="person" type="text" class="form-control" value="">
                                        </div>
                                        <!-- search button -->
                                ...
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <a class="accordion-toggle" data-parent="#accordion" data-toggle="collapse" href="#collapseThree">
                                            <div class="caret pull-right"></div>关联数据
                                        </a>
                                    </div>
                                </div>
