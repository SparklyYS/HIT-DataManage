      ...
      <div class="row">
          <div class="col-lg-12">
            <div class="widget-container fluid-height clearfix">
              <div class="heading">
                <i class="icon-tasks"></i>新建PDO<button class="btn btn-sm btn-primary-outline pull-right" id="add-row" onclick="Hello()"><i class="icon-plus"></i>添加属性</button>
              </div>
              <table class="table table-bordered table-striped" id="tabletemplate" style="display: none">
                  <thead>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <input name="Property" class="form-control">
                      </td>
                      <td>
                        <button id="Button2" onclick="deltr(this)" class='btn btn-danger btn-sm glyphicon glyphicon-remove row-remove'></button>
                      </td>
                    </tr>
                  </tbody>
              </table>
                ...
                <table class="table table-bordered table-striped" id="dynamictable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <input name="Property[0]" class="form-control">
                      </td>
                    </tr>
                    <tr>
                      <td name="No" width=6%>
                      ...
                      <td>
                        <input name="Property[1]" class="form-control">
                      </td>
                      <td>
                        <button id="Button2" onclick="deltr(this)" class='btn btn-danger btn-sm glyphicon glyphicon-remove row-remove'></button>
                      </td>
...
function ChangeIndex(){
  ...
  $('#dynamictable tbody tr').each(function(){
    $(this).find("td[name='No']").html("属性ID: "+ index);
    $(this).find("input").attr("name", "Property"+"["+ index + "]");
    index++;
  });
}
