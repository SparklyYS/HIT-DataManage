...
<!-- 				<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br> -->
	...
	<div class="page-content-wrapper">
			...
			<div class="portlet light bordered form-fit">
				<div class="portlet-title">
					<div class="caption">
						...
						<span class="caption-subject font-blue-hoki bold uppercase">新建PDO</span>
					</div>
					<div class="actions">
						<button id="btn_addr" onclick="Hello()" class="btn green">
		...
		<tbody>
			<tr>
				<td name="No"></td>
				<td><input name="PropertyList" class="form-control"></td>
				<td>
				<button id="Button2" onclick="deltr(this)" class='btn btn-danger glyphicon glyphicon-remove row-remove'></button>
				</td>
			</tr>
		</tbody>
		</table>
		<div class="portlet-body form">
		<form action="" method="get" name="DynamicForm">
		<table id="dynamictable" class="table table-bordered table-hover table-sortable">
			<thead>
			</thead>
			<tbody>
				<tr>
					<td name="No">属性ID： 1</td>
					<td><input name="PropertyList" class="form-control"></td>
					<td>
					<button id="Button2" onclick="deltr(this)" class='btn btn-danger glyphicon glyphicon-remove row-remove'></button>
					</td>
